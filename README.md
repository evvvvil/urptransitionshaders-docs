...
If the meshes in the ExampleTransition scene appear **$\color{pink}\Huge{\textsf{PINK}}$** then you are using the wrong package version for your Unity editor version.
