...
Start the transition fade from 0 to 1, animated over a duration of `duration` (in seconds).

**FadeOut(float duration)**
Start the transition fade from 1 to 0, animated over a duration of `duration` (in seconds).